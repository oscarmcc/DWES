...
class UsuarioController extends BaseController
{
    public function loginAction()
    {
        ...
        if (!empty($_POST)) {
            ...
            echo (password_verify($data['passwd'], $resultado[0]['passwd']));
            // Verificar la contraseña ingresada con el hash almacenado
            if (password_verify($data['passwd'], $resultado[0]['passwd']) && $resultado[0]['cuenta_activa'] == 1) {
    ...
    public function verificarAction()
{
    ...
    public function visibilizarAction()
{
    $usuario = Users::getInstancia();
    $usuarioData = $usuario->get($_SESSION['id']);

    if ($usuarioData['visible'] == 1) {
        $usuario->setVisibilidad(0, $_SESSION['id']);
    } else {
        $usuario->setVisibilidad(1, $_SESSION['id']);
    }
    ...
    public function perfilAction()
    {
        ...
        $data = [];
        $usuario = Users::getInstancia()->get($_SESSION['id']);
